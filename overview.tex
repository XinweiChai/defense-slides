\begin{tikzpicture}[mindmap,
    ...
    \begin{scope}[mindmap, concept color=blue,text=white]
            \node<1-> [concept] (bioapp) at (2,3.4) {Biological Applications} [counterclockwise from=30] 
    ...
    \begin{scope}[mindmap, concept color=orange, text=white]
        \node<2-> [concept] (exp) {Experimental Approaches}[counterclockwise from=90] 
    ...
    \begin{scope}[mindmap, concept color=red,text=white]
        \node<4-> [concept] (mod) at (4,0) {Modeling and Computation}[counterclockwise from=0] 
