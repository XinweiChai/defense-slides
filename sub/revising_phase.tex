...
\begin{itemize}
    ...
    \begin{itemize}
        \item Ensure unreachability by inhibiting elements in corresponding cut set
        \item Ensure reachability by guaranteeing elements in corresponding completion set
    \end{itemize}
