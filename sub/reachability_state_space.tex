...
\end{column}
\begin{column}{0.5\textwidth}
\onslide<5>{Reachability of digraph needs at least polynomial time and space wrt the number of nodes, but the number of nodes is exponential to variables
