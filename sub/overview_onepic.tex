...
\begin{frame}{Problematics}
    \begin{tikzpicture}[line,>=stealth]
        \node [color=gray,label=above:{Real system dynamics}] (realSys) {\includegraphics[scale=0.5]{realSystem.pdf}};
        ...
        \node [color=blue,right = of realSys,label=above:{Biological \textit{a priori} knowledge}] (bioNet) {\includegraphics[scale=0.2]{biologicalNetwork.jpg}};
