\begin{tikzpicture}[-{Latex[length=1.5mm]}]
  \onslide<1->{\node[inner sep=0pt] (cell) {\includegraphics[width=0.45\textwidth]{figures/BooleanNetwork.png}};}
...
\onslide<13->{\draw[-{Latex[length=1.5mm]}, thick, loop above,dashed] (b) to (b);}
\end{tikzpicture}